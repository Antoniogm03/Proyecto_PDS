...
for wav_file in iglob(os.path.join('audios', '*.wav')):
    ...
    reg_user_vocal_fingerprint[user_id] = asv.compute_vocal_fingerprint_nota_musical(wav_file)
...
def register():
    ...
    reg_user_vocal_fingerprint[user_id] = asv.compute_vocal_fingerprint_nota_musical(audio_path)
...
def verify():
    ...
    test_fingerprint = asv.compute_vocal_fingerprint_nota_musical(test_audio_path)
